...
var AWS = (function() {
    ...
    var accessKey = userProperties.getProperty('AWS_ACCESS_KEY');
    var secretKey = userProperties.getProperty('AWS_SECRET_KEY');
    var region = userProperties.getProperty('AWS_REGION');
    ...
    return {
         ...
         */
         init: function AWS(access_key, secret_key, region) {
         ...
         */
         request: function(service, action, params, method, payload, headers, uri) {
         ...
         */
        post: function(service, action, payload, headers, uri) {
            var headers = headers || {};
            headers["Content-Type"] = "application/x-amz-json-1.1";

            var response = this.request(service, action, null, "POST", payload, headers, uri);
            try {
